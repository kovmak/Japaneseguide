...
public class Other {
    ...
    public void printOtherEvents(String filePath) {
        try {
            ...
            if (jsonObject != null) {
                // Припускаємо, що iсторичнi подiї зберiгаються у властивостi з назвою "Other History"
                ...
                if (eventsArray != null) {
                    ...
                    System.out.println("Помилка: Поле 'Other History' не знайдене у файлi або воно не є масивом ");
                }
            } else {
    ...
    private void printEventInfo(JsonObject eventObject) {
        System.out.println("Iнформацiя про iншi iсторичнi подii :");
